...
<div class="card">
    <div class="card-header ">
        <h3 class="card-title">Sound list</h3>
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ date('d/m/y - H:i:s',strtotime($sound->created_at))}}
                    </td>
                    <td>
                        {{ date('d/m/y - H:i:s ', strtotime($sound->updated_at))}}
                    </td>
                    <!-- <td> <a href="{{ route('admin.sound.edit', ['id' => $sound->id]) }}">
                            Edit </a>
                    </td>
                    <td> <a onclick="return confirmationDelete('sound')"
                            href="{{route('admin.sound.destroy', ['id'=> $sound->id])}}"> Delete </a> </td> -->
                </tr>
                @endforeach
            </tbody>
            <tfoot>
