...
<div class="card">
    <div class="card-header ">
        <h3 class="card-title">Membership Package list</h3>
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> {{ number_format($pack->price) }} đ</td>
                    <td> {{ $pack->benefit}}</td>
                    <td> {{ date('d/m/y - H:i:s', strtotime($pack->created_at)) }}</td>
                    <td>{{ date('d/m/y - H:i:s', strtotime($pack->updated_at)) }}</td>
                    <td><a href=" {{ route('admin.membershippackage.edit', ['id' => $pack->id]) }}">Edit</a></td>
                    <td><a onclick=" return confirmationDelete('membershippackage')"
                            href=" {{ route('admin.membershippackage.destroy', ['id' => $pack->id]) }}">Delete </a>
                    </td>
                </tr>
                @endforeach
            </tbody>
