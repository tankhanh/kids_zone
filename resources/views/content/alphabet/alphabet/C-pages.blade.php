...
<head>
    ...
    <title>Kids Zone - The Letter C</title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h3>Kids Zone Learning <span>The Letter C</span></h3>
            <p>You will be able to sound out and recognize the letter c.</p>
    ...
    <section class="lesson" id="lesson">
        ...
        <div class="row">
            ...
            <div class="content">
                <h3>The Letter of the Day: C</h3>
                <p>Click on the video below to watch the song about the letter C.</p>
                <div class="video-container">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/hSk_fgAAjjs?si=W3AkY2SyDLozOmey" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="gallery-container">
            ...
            <a href="{{asset('img/images/C.png')}}" class="box">
                <img src="{{asset('img/images/C.png')}}" alt="">
                <div class="icon"> <i class="fas fa-plus"></i></div>
            </a>

            <a href="{{asset('img/images/CW.png')}}" class="box">
                <img src="{{asset('img/images/CW.png')}}" alt="">
                <div class="icon"> <i class="fas fa-plus"></i></div>
            </a>
