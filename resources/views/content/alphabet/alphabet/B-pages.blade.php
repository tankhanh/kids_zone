...
<head>
    ...
    <title>Kids Zone - The Letter B</title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h3>Kids Zone Learning <span>The Letter B</span></h3>
            <p>You will be able to sound out and recognize the letter b.</p>
    ...
    <section class="lesson" id="lesson">
        ...
        <div class="row">
            ...
            <div class="content">
                <h3>The Letter of the Day: B</h3>
                <p>Click on the video below to watch the song about the letter B.</p>
                <div class="video-container">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/RoFz9V_BEG4?si=oilfgb9zF_WM-nch" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="gallery-container">
            ...
            <a href="{{asset('img/images/B.png')}}" class="box">
                <img src="{{asset('img/images/B.png')}}" alt="">
                <div class="icon"> <i class="fas fa-plus"></i></div>
            </a>

            <a href="{{asset('img/images/BW.png')}}" class="box">
                <img src="{{asset('img/images/BW.png')}}" alt="">
                <div class="icon"> <i class="fas fa-plus"></i></div>
            </a>
