...
<head>
    ...
    <title>Kids Zone - The Letter D</title>
    <!-- font awesome cdn link  -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <!-- lightgallery css cdn link -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/lightgallery-js/1.4.0/css/lightgallery.min.css">
    <!-- custom css file link  -->
    <link rel="stylesheet" href="{{asset('user/css/abc.css')}}">
</head>
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h3>Kids Zone Learning <span>The Letter D</span></h3>
            <p>You will be able to sound out and recognize the letter d.</p>
            <p>Scroll down to learn.</p>
            <a href="{{ asset('lessons')}}" class="btn">More Lessons</a>
        </div>

        <div class="image">
            <img src="{{asset('img/images/home.png')}}" alt="">
        </div>
    ...
    <section class="lesson" id="lesson">
        ...
        <h1 class="heading"> <span>Letters of the Alphabet</span></h1>
        ...
        <div class="row">
            ...
            <div class="content">
                <h3>The Letter of the Day: D</h3>
                <p>Click on the video below to watch the song about the letter D.</p>
                <div class="video-container">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/U2IEwUFCKzg?si=JeogpH6U1DjpPggC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="gallery-container">
            ...
            <a href="{{asset('img/images/D.png')}}" class="box">
                <img src="{{asset('img/images/D.png')}}" alt="">
                <div class="icon"> <i class="fas fa-plus"></i></div>
            </a>

            <a href="{{asset('img/images/DW.png')}}" class="box">
                <img src="{{asset('img/images/DW.png')}}" alt="">
                <div class="icon"> <i class="fas fa-plus"></i></div>
            </a>
