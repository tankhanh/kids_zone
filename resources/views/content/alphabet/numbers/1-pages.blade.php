...
<head>
    ...
    <title>Kids Zone - The Number 1</title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h3>Kids Zone Learning <span>The Number 1</span></h3>
            <p>You will be able to sound out and recognize the number 1.</p>
    ...
    <section class="lesson" id="lesson">
        ...
        <div class="row">
            ...
            <div class="content">
                <h3>The Number of the Day: 1</h3>
                <p>Click on the video below to watch the song about the number 1.</p>
                <div class="video-container">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/Huggdy7ohb4?si=HqRgfMsJw4UFZ7L2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="gallery-container">
            ...
            <a href="{{asset('img/images/1.png')}}" class="box">
                <img src="{{asset('img/images/1.png')}}" alt="">
                <div class="icon"> <i class="fas fa-plus"></i></div>
            </a>

            <a href="{{asset('img/images/1c.png')}}" class="box">
                <img src="{{asset('img/images/1c.png')}}" alt="">
                <div class="icon"> <i class="fas fa-plus"></i></div>
            </a>
