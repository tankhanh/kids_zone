        ...
        < Back</a>
            ...
            <div class="menus">
                <div class="menu menu--main">
                    <h1>BLOCK MENJA</h1>
                    <button type="button" class="play-normal-btn" onclick="hideBackButton()">PLAY GAME</button>
                    <button type="button" class="play-casual-btn" onclick="hideBackButton()">NORMAL MODE</button>
                    <!-- <div class="credits">A game by Zayan Mohammed</div> -->
                </div>
                <div class="menu menu--pause">
                    <h1>Paused</h1>
                    <button type="button" class="resume-btn">RESUME GAME</button>
                    <button type="button" class="menu-btn--pause" onclick="displayBackButton()">MAIN MENU</button>
                </div>
                <div class="menu menu--score">
                    ...
                    <button type="button" class="menu-btn--score" onclick="displayBackButton()">MAIN MENU</button>
                </div>`
            </div>
</body>
<script>
